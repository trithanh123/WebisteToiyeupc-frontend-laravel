...
const UserManagement = () => {
  ...
  // Lấy danh sách người dùng từ API bằng Axios
  ...
  // Xóa người dùng bằng SweetAlert2
  ...
  // Reset trang về 0 nếu đổi filter hoặc search
  useEffect(() => {
    setItemOffset(0);
  }, [search, filterRole]);
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        {!loading && !error && (
          <div className="p-3 px-5 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
            ...
            {pageCount > 1 && (() => {
              // Xử lý lỗi import default của vite với react-paginate
