...
const ProductDetailPage = () => {
  ...
  const HIDDEN_SPEC_TYPES = ['other']; // ẩn use_case và các field không cần hiển thị
  const specs = parseSpecs(product.specifications).filter(s => !HIDDEN_SPEC_TYPES.includes(s.type));
