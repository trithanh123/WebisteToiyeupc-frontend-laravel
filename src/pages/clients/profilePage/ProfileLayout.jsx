    ...
    <div className="min-h-screen bg-[#f0f2f5] py-6">
      <div className="max-w-[1100px] mx-auto px-4 flex gap-4 items-start">
        ...
        <aside className="w-[220px] flex-shrink-0 sticky top-20">
          ...
          {}
          <Link to={ROUTERS.CLIENT.HOME} className="mb-4 inline-flex items-center gap-2 text-sm text-gray-500 hover:text-blue-600 font-medium transition-colors bg-white px-4 py-2 rounded-xl shadow-sm border border-gray-100 w-full justify-center">
