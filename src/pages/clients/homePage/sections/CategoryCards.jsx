...
const cards = [
  {
    ...
    link: "/san-pham?danh-muc=pc-toiyeupc"
  },
  {
  ...
  },
  {
    ...
    link: "/san-pham?danh-muc=laptop-gaming"
  },
  {
    ...
    link: "/san-pham?danh-muc=man-hinh"
  },
  {
    ...
    link: "/san-pham?danh-muc=ban-phim"
  },
  {
    ...
    <section className="bg-white py-6">
      <div className="max-w-[1280px] mx-auto px-4 grid grid-cols-4 gap-5">
        ...
        {cards.map((card, i) => (
          <Link
            key={i}
            to={card.link || ROUTERS.CLIENT.PRODUCTS}
