    ...
    if (isOpen) {
      if (branch) {
        setFormData({
          ...
          Ma_chi_nhanh: branch.ma_chinhanh || '',
          SDT_Chi_nhanh: branch.sdt_chinhanh || '',
          email_chi_nhanh: branch.email_chinhanh || '',
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="text" required value={formData.sdt_chinhanh} onChange={e => setFormData({ ...formData, SDT_Chi_nhanh: e.target.value })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                  placeholder="09xx..." />
              </div>
