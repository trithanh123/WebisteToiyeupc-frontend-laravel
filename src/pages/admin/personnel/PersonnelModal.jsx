    ...
    if (isOpen) {
      if (personnel) {
        ...
        setFormData({
          ...
          machinhanh: personnel.machinhanh || '',
          existing_user_id: ''
        });
      } else {
        setFormData({
          ...
          <div className="bg-emerald-50/50 p-4 rounded-xl border border-emerald-100">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select required value={formData.machinhanh} onChange={e => setFormData({ ...formData, machinhanh: e.target.value })}
                  ...
                  {branches.map(b => (
                    <option key={b.id_chinhanh} value={b.id_chinhanh}>[{b.ma_chinhanh}] {b.ten_chinhanh}</option>
                  ))}
                </select>
              </div>
